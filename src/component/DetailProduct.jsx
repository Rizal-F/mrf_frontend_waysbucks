    ...
    return(
        <div className="flex mx-32">
            ...
            <div className=" text-brand-red w-3/5 ml-10">
                ...
                <div className="flex text-sm flex-wrap text-center justify-between items-center cursor-pointer">
                ...
                <div className="bg-brand-red text-white px-64 py-1 rounded-md text-center mt-14 mb-14 cursor-pointer">
